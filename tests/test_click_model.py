...
def test_reset_positions(click_model):
    ...
    click_model.positions["click1"] = (500, 500)
...
def test_set_position(click_model):
    """Test setting a new position for an action."""
    click_model.set_position("click1", 1000, 1000)
...
def test_load_positions_file_not_found(mock_file, click_model):
    ...
    click_model.positions["click1"] = (100, 100)  # Set default explicitly
    click_model.load_positions()
